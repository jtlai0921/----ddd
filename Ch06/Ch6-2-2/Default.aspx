...
ZH-TW;mso-bidi-language:AR-SA">2: </span>
                ...
                <td>
                    ...
                    <br />
                    <asp:CompareValidator ID="validComp" runat="server" ErrorMessage="兩次輸入的密碼不同!" 
            ...
            <tr>
                ...
                <td>
                    ...
                    <asp:CompareValidator ID="validConstant" runat="server" 
                        ErrorMessage="購買數量需要大於等於1!" Display="Dynamic" 
                        ControlToValidate="txtQuantity" Operator="GreaterThanEqual" Type="Integer" 
